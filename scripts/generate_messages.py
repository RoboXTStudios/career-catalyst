...
DYNAMIC_MESSAGE_FOCUS = {
    ...
    "paid_media": "paid media execution, campaign setup and optimization, measurement and tracking, and release-driven or awards-season campaigns",
...
DYNAMIC_MESSAGE_PROOF = {
    ...
    "paid_media": "I led enterprise entertainment media operations spanning Ad Operations, platform governance, tagging, and measurement readiness for theatrical and streaming campaigns.",
