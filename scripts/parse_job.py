...
METADATA_LABELS = {
    ...
    "salary_source": ("salary source", "salary provenance"),
...
def extract_metadata(text: str) -> Dict[str, Optional[str]]:
    ...
    metadata = {
        ...
        "salary_source": _extract_labeled_value(text, METADATA_LABELS["salary_source"]),
...
def parse_job_description(file_path: PathInput) -> Dict[str, Any]:
    ...
    parsed = {
        ...
        "salary_source": metadata["salary_source"],
