...
OUTPUT_LABELS = {
    ...
    "ats_parsed_preview": "ATS parsed preview",
    "requirement_coverage_matrix": "Requirement coverage matrix",
    "interview_conversion_gate": "Interview conversion gate",
...
PACKAGE_MATERIAL_LABELS = {
    ...
    "ATS Parsed Preview": "ATS parsed preview",
    "Requirement Coverage Matrix": "Requirement coverage matrix",
    "Interview Conversion Gate": "Interview conversion gate",
...
MATERIAL_GROUPS = {
    ...
    "Strategy/Prep": ("Strategy Pack", "Interview Prep", "Package Summary", "ATS Parsed Preview", "Requirement Coverage Matrix", "Interview Conversion Gate"),
