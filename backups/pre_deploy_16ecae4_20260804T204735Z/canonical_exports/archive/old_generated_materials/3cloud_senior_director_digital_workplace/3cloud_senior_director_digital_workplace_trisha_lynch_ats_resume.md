...
### Disney Floodlight Tracking Database and Data Technology Map

OMG23 (Omnicom Media Group) · The Walt Disney Company · Database and Technical Knowledge System

- Designed and built a Microsoft Access database for centralized Floodlight tracking, using Microsoft Excel as the structured raw-data source.
- The database became the primary Floodlight tracking system used by the Disney account team before the organization restructured following the Disney+ launch.
