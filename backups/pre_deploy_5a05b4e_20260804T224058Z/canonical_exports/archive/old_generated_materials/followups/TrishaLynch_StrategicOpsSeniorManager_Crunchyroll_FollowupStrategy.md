...
- Grounding reviewed:
  ...
  - data/projects.yml
  - exports/strategy_packs/TrishaLynch_StrategicOpsSeniorManager_Crunchyroll_StrategyPack.md
  - exports/messages/TrishaLynch_StrategicOpsSeniorManager_Crunchyroll_CoverLetter.md
  - exports/messages/TrishaLynch_StrategicOpsSeniorManager_Crunchyroll_RecruiterMessage.md
  - exports/messages/TrishaLynch_StrategicOpsSeniorManager_Crunchyroll_HiringManagerMessage.md
  - exports/messages/TrishaLynch_StrategicOpsSeniorManager_Crunchyroll_ApplicationNote.md

### Best Outreach Angle

Lead with ownership, capacity planning, decision cadence, and cross-functional delivery. Keep the note focused on the operating challenge and the value Trisha can add, rather than restating the application.
...
I'm preparing an application for the Strategic Operations Senior Manager role at Crunchyroll. Because you know my work, I wanted to ask whether you would consider referring me or sharing my application with the right person, only if you feel comfortable. The focus on ownership, capacity planning, decision cadence, and cross-functional delivery connects closely with the kind of work I have led. There is no obligation at all. Your candid perspective on the role or the best path forward would be valuable either way.
